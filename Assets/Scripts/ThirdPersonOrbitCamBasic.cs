...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	public float horizontalAimingSpeed = 15f;                           // Horizontal turn speed.
	public float verticalAimingSpeed = 15f;                             // Vertical turn speed.
	...
	public bool collisionDetection = false;                                  // The default vertical axis input name.
    ...
    void Update()
    {
        ...
        {
            // Joystick:
            angleH += touchPanel.Horizontal * horizontalAimingSpeed * Time.deltaTime;
            angleV += touchPanel.Vertical * verticalAimingSpeed * Time.deltaTime;
        }
        else
        {
            // Mouse:
